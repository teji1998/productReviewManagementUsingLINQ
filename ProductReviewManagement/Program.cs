    ...
    class Program
    {
        static void Main(string[] args)
        {
            ...
            List<ProductReview> productReviewList = new List<ProductReview>()
            {
                ...
                new ProductReview() { ProductId = 8, UserId = 5,  Rating = 5, Review = "nice", isLike = false },
                ...
                new ProductReview() { ProductId = 12,UserId = 12, Rating = 6.4, Review = "nice", isLike = true },
                new ProductReview() { ProductId = 13,UserId = 12, Rating = 7, Review = "Good", isLike = true },
